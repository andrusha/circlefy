...
class hyves extends OpenInviter_Base
	...
	public function login($user,$pass)
		...
		$url_friends_array=$this->getElementDOM($res,"//a[@class='listitemmenu']",'href');
		$url_friends=$url_friends_array[1];
	...
	public function getMyContacts()
		...
		while (strpos($res,'memberlistname')!==false)
			{
			...
			$page=$page+10;
			$member_id=$this->getElementString($res,'index.php?l1=mo&amp;l2=fr&amp;l3=list&amp;member_id=','&amp;');$next_page="http://www.hyves.nl/index.php?l1=mo&l2=fr&l3=list&member_id={$member_id}&startpos={$page}";
			$res=$this->get($next_page,true);
			} 
		return $contacts;
		}
